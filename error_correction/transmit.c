...

{
	...
	// set parity bit p1
	if (((isShortBitSet(*num,3) + isShortBitSet(*num,5) + isShortBitSet(*num,7) + isShortBitSet(*num,9) + isShortBitSet(*num,11)) % 2) == 1)
	setShortBit(1,num);
	...
	// set parity bit p2
	if (((isShortBitSet(*num,3) + isShortBitSet(*num,6) + isShortBitSet(*num,7) + isShortBitSet(*num,10) + isShortBitSet(*num,11)) % 2) == 1)
	setShortBit(2,num);
	...
	// set parity bit p4
	if (((isShortBitSet(*num,5) + isShortBitSet(*num,6) + isShortBitSet(*num,7) + isShortBitSet(*num,12)) % 2) == 1)
	setShortBit(4,num);
    ...
    // set parity bit p8
	if (((isShortBitSet(*num,9) + isShortBitSet(*num,10) + isShortBitSet(*num,11) + isShortBitSet(*num,12)) % 2) == 1)
	setShortBit(8,num);
